...
public class ReminderDbContext :
    AbpDbContext<ReminderDbContext>
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
       ...
       // builder.ConfigurePermissionManagement();
        ...
        //{
        //    b.ToTable(ReminderConsts.DbTablePrefix + "YourEntities", ReminderConsts.DbSchema);
        ...
        builder.Entity<Message>(b =>
        {
            ...
            b.Property(x => x.Text).IsRequired().HasMaxLength(20000);
